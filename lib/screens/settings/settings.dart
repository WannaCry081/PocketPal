                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        settingsItemSwitch(
                          FeatherIcons.moon, 
                          "Dark Mode", 
                          settingsProvider.getBoolPreference("isLight"), 
                          (value) => settingsProvider.setBoolPreference("isLight", value)),
                        settingsItemSwitch(
                          FeatherIcons.bell, 
                          "Push notifications", 
                          false, 
                          (value) => settingsProvider.setBoolPreference("isLight", value) //temp
                          ),
                      ],
                    ),
                  )
...
Widget settingsItemSwitch (prefixIcon, itemName, value, onChanged) => Row(
  children:[
    Icon(
      prefixIcon,
      size: 26),
